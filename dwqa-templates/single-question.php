...
.dwqa-container  {margin-left:20px;}
.dwqa-comment-content-inner {margin-left:18px;}
.dwqa-content {margin-left:18px;}
.dwqa-comment-content .dwqa-comment-content-inner {margin-left:12px;}
.dwqa-container .dwqa-comment-content {margin:1em 50px;}
.dwqa-single-question .author{margin-left:50px;}
.dwqa-single-question .dwqa-question .dwqa-content{margin-left:90px;}
</style>
