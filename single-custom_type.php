                 ...
                 <div id="main" class="col-xs-12 col-md-8" role="main">
							...
							<article id="post-<?php the_ID(); ?>" role="article">
								...
								<section class="entry-content ">
									<?php
										...
										*/
										wp_link_pages( array(
											'before'      => '<div class="page-links"><span class="page-links-title">' . __( 'Pages:', 'bootztheme' ) . '</span>',
											'after'       => '</div>',
											'link_before' => '<span>',
											'link_after'  => '</span>',
										) );
								...
								<footer class="article-footer">
									<p class="tags"><?php echo get_the_term_list( get_the_ID(), 'custom_tag', '<span class="tags-title">' . __( 'Custom Tags:', 'bootztheme' ) . '</span> ', ', ' ) ?></p>
							...
							<?php else : ?>
									...
									<article id="post-not-found" class="hentry ">
										...
										<footer class="article-footer">
											<p><?php _e( 'This is the error message in the single-custom_type.php template.', 'bootztheme' ); ?></p>
										</footer>
									</article>
