...
<div class="row">
  <div class="col-xs-12">
								...
								<div class="masonry">
                                 <?php query_posts('category_name=expand&showposts=10' );?>
   ...
   <h4 style="padding:0 5px 0 5px;"><a style="color:#333; text-align: justify;" href="<?php the_permalink();?>"><?php the_title(); ?></a></h4>
