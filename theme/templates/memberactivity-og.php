...
<div role="navigation" style="margin:0 !important;">
<ul>
...
<li id="activity-filter-select" style="margin: 13px 0 0 !important;">
<label for="activity-filter-by" style=" position: relative;top: -4px;"><?php _e( 'Show:', 'buddypress' ); ?></label>
